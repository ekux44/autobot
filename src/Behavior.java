...
public abstract class Behavior {
	...
	/** Returns randomized sleep time for the associated action. Care should be taken when shortening existing times as this may break existing Behaviors**/
	protected int getTime(Times type) {
		...
		case KEYPRESS: return Random.nextGaussian(80, 130, 100, 15);
		}
		return 0;
	}
